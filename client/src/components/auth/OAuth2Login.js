        ...
        <Col xs={12} sm={8} md={6} lg={4} xl={3}>
          <Card className="modern-card p-4 p-md-5 rounded-4">
            ...
            <div className="text-center mb-5">
              ...
              <p className="text-muted mb-0">Continue with your preferred account</p>
            </div>
            ...
            <div className="oauth2-section mb-4">
              ...
              <Button
                ...
                className={`oauth2-btn w-100 py-3 mb-4 fw-semibold rounded-3 d-flex align-items-center justify-content-center ${
              ...
              >
                {oauth2Loading === "github" ? (
                  ...
                  <>
                    <svg className="me-2" width="20" height="20" viewBox="0 0 24 24" fill="#333">
